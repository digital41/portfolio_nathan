...
var SiteComponents = (function () {
    ...
    var isIndex = cur === 'index.html' || cur === '' || cur === '/';
    ...
    function footer() {
        ...
        html += fLink(s + 'strategie-ia.html', 'Stratégie IA & Agents', 'strategie-ia.html');
        html += fLink(s + 'automation-n8n.html', 'Automation n8n', 'automation-n8n.html');
        html += fLink(s + 'audit-performance-it.html', 'Audit Performance IT', 'audit-performance-it.html');
        html += fLink(s + 'dsi-externalise.html', 'DSI Externalisé', 'dsi-externalise.html');
        html += fLink(s + 'data-erp.html', 'Data & ERP', 'data-erp.html');
        html += fLink(s + 'cybersecurite-infrastructure.html', 'Cybersécurité & Cloud', 'cybersecurite-infrastructure.html');
        html += '</nav>';
        html += '</div>';
        ...
        html += fLink(s + 'strategie-marketing-branding.html', 'Marketing & Branding', 'strategie-marketing-branding.html');
        html += fLink(s + 'seo-acquisition-digitale.html', 'SEO & Référencement', 'seo-acquisition-digitale.html');
        html += fLink(s + 'geo-referencement-ia.html', 'GEO Référencement IA', 'geo-referencement-ia.html');
        html += fLink(s + 'google-business-profile.html', 'Google Business Profile', 'google-business-profile.html');
        html += fLink(s + 'publicite-digitale.html', 'Publicité Digitale & Ads', 'publicite-digitale.html');
        html += '</nav>';
        html += '</div>';
        ...
        html += fLinkIcon(p + 'contact.html', 'fas fa-envelope', 'Contact', 'contact.html', false);
        html += '<hr class="border-white/5 my-2">';
        html += fLink(p + 'mentions-legales.html', 'Mentions légales', 'mentions-legales.html');
